...
%Made without any official affiliations and/or endorsements from the School of Government and Public Policy (SGPP) Indonesia
...
\begin{document}
	\titlegraphic{\includegraphics[height=3.5cm,width=3.5cm]{SGPP Logo Secondary Print}\vspace{-25pt}}
